...
public class InputSignaturePage extends CommonActions{
	...
	public InputSignaturePage(WebDriver driver) throws Exception {

		super();
		this.driver = driver;
		PageFactory.initElements(driver, this);

		waitForElementVisible(inputTitleElement, driver, "Wait for inputTitleElement visible");

	}

	public void clickOnPlusIcon() throws Exception {

		click(plusIconElement, driver, "Clicking on plus icon on input signature  page........");
	...
	public boolean verifyInputField(String fieldName) 
	{
	  ...
	  public  void clickOnOutput() throws Exception 
	  {
		  ...
		  click(outputTitleElement, driver, "Click on outputTitleElement element");
