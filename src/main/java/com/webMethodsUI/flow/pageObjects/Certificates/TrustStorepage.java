...
public class TrustStorepage extends CommonActions{
    ...
    public TrustStorepage(WebDriver driver) throws Exception{
        super();
        this.driver = driver;
        PageFactory.initElements(driver, this);
        waitForElementVisible(trutStoreTitlepage, driver, "Verify trustore heading is visible" );
        
    }


    //public void EnteringKeyStoreName(String KeystoreName)
    public String EnteringKeyStoreName(String KeystoreName)
    {
