...
public class importExportpageforWorkflow extends CommonActions{

    private WebDriver driver;
    private Logger log = LogManager.getLogger(importExportpageforWorkflow.class);
    ...
    public importExportpageforWorkflow(WebDriver driver){
        super();
        this.driver = driver;
        ...
        waitHelper.waitForElement(thatpageelement, ObjectReader.reader.getExplicitWait());
