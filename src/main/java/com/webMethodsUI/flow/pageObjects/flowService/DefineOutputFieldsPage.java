...
public class DefineOutputFieldsPage extends CommonActions{
	...
	public void createOutputDataFieldNew(int index, String dataFieldName) {
		log.info("  Creating dataField  on  output field  page ...");

		WebElement elemntArray = driver.findElement(By.xpath("//input[@placeholder='Field name']"));
		log.info("All input parameters are....." + elemntArray);
		//WebElement element = elemntArray.get(index);
		log.info("element at index..." + index + "......" + elemntArray);
		logExtentReport("element at index..." + index + "......" + elemntArray);
		elemntArray.click();
		elemntArray.clear();
		elemntArray.sendKeys(dataFieldName);
