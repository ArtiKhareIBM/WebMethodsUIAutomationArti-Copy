...
//	}
	...
	{
		WebElement element = findElement("(//*[contains(text(),'"+parameter+"')]//ancestor::div[@class='tree-context']/preceding-sibling::div[@class='tree-icon-container']/span/i)[1]",driver);
		click(element,driver,"Expand the field... "+parameter);
	}

	public void doubleclickonparameter(String paramName) throws Exception
	{
		WebElement element = findElement("//span[@data-flow-title='"+ paramName +"']",driver);
		doubleClick(element, driver, "double clicking on child parameter...." + paramName);
	}

	public void clickonpubnubnubchannel() throws Exception
	{
		WebElement element = findElement("//span[@data-flow-title='Channel']",driver);
		doubleClick(element, driver, "double clicking on pubnub channel....");
	}

	public void clickonpubnubnubmessage() throws Exception
	{
		WebElement element = findElement("//span[@data-flow-title='Message']",driver);
	...
	public void verifyFieldWithParamater(String dataType,String fieldName) throws Exception 
	{
		WebElement element = findElement("//div[contains(text(),'"+dataType+"')]/..//div//span[contains(text(),'"+fieldName+"')]",driver);
		waitForElementVisible(element,driver,"Verify field "+fieldName+" of datatype "+dataType+" is visibe");
	}
