...
public class FlatfileOperationsPage extends CommonActions{
	WebDriver driver;
	...
	public void getOperationPageTitle() throws Exception {
		...
		elementContainsText(element, "Sample_Flatfile_Connector Operations", driver, "Verify Operation page title is visible");
	}
	...
	public void getShowIoOperationPageTitle() throws Exception {
		...
		elementContainsText(element, "convertFlatFileToDocument Input and Output Signature", driver, "Verify showIoOperation page title is visible");
	}
