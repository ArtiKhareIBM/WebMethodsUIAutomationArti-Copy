...
public class RecipeAccountSelectingpage extends CommonActions{
    WebDriver driver;
...
//        WebElement element = list.get(index);
        ...
        WebElement element = driver.findElement(By.xpath("//div[@class='accounts-selection']/div["+index+"]/div[2]/div[1]/div/div/div[2]"));      
        Thread.sleep(1000);
        element.click();
        Thread.sleep(1000);
