...
public class choosingProjectpage extends CommonActions{
    WebDriver driver;
    ...
    @FindBy(xpath = "//input[@aid='material-select-id']")
    @CacheLookup
    ...
    public void clicktheDropdownRecipe(String ProjectName) throws Exception{
