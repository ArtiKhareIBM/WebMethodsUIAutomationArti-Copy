...
public class Deploypage {
    ...
    public Deployconfigurationpage clickSaveAndcontinuebutton(){
        log.info("Clicking Save And continue button");
        logExtentReport("Clicking Save And continue button");
        SaveAndcontinuebutton.click();
        return new Deployconfigurationpage(driver);
    }

    public void Renametheproject(String reProjectName){
        log.info("Entering new projectName" + reProjectName);
        logExtentReport("Entering new projectName" + reProjectName);
        RenameprojectField.click();
        RenameprojectField.clear();
        RenameprojectField.sendKeys(reProjectName);
    }
