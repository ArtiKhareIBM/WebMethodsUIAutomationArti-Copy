...
public class OperationList {
	...
	public void clickSoapConnectorLink() {

		log.info("Clicking on  Link.... " + soapConnectorLinkElement.getText());
		logExtentReport(" Clicking on Link with name ..... " + soapConnectorLinkElement.getText());
		waitHelper.waitForElement(soapConnectorLinkElement, ObjectReader.reader.getExplicitWait());
		soapConnectorLinkElement.click();
