...
public class SoapApiHomePage {
	...
	@CacheLookup
	WebElement editSoapApiElement;    //SoapApiBasicInfoPage
	...
	public SoapApiHomePage(WebDriver driver) {
		...
		waitHelper.waitForElement(soapApiHomePageTitleElement, ObjectReader.reader.getExplicitWait());
		
		log.info("element is visible now........................................"+soapApiHomePageTitleElement);
	...
	public SoapApiLetsGetStartedPage clickOnCreateApiButton() {
	
		log.info("clicking on create api button...");
		logExtentReport("clicking on create api button...");
	...
	public void deleteSoapAPI(String soapApiName) {
		
		WebElement element = driver.findElement(By.xpath("//span[contains(text(),'"+soapApiName+"')]/parent::div/parent::div//a[@title='Delete SOAP API']"));
		log.info("Deleting element is...." +element);
		...
		deleteButtonElement.click();
           ...
           public SoapApiBasicInfoPage editSoapApi() {
		
		log.info("Editing the soap api..............");
		logExtentReport("Editing the soap api..............");
		waitHelper.waitForElement(editSoapApiElement, ObjectReader.reader.getExplicitWait());
		editSoapApiElement.click();
...
public void copySoapAPI(String copysoapApiName, String projectName) {
	...
	log.info("clicking on copy icon on soap api page   ...");
      ...
      public void clickOnSoapApiNameLink(String soapApiName) {
 		 
 		 log.info("clicking   on soap Api name  link..."+soapApiName );
 	  		logExtentReport("clicking on soap Api name  link...."+soapApiName );
 	  		WebElement element = driver.findElement(By.xpath("//span[contains(text(),'"+soapApiName+"')]"));
		  waitHelper.waitForElement(element, ObjectReader.reader.getExplicitWait());
 	  		element.click();
      ...
      public String getApiEmptyMessageDisplay() {
